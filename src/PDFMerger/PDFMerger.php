...
class PDFMerger
{
     ...
     * @return string
     */
    public function addString($string, $pages = 'all', $orientation = null, $rotation = null)
    {
        ...
        return $this->addPDF($filePath, $pages, $orientation, $rotation);
    }
     ...
     */
    public function addPDF($filePath, $pages = 'all', $orientation = null, $rotation = null)
    {
        ...
        $this->aFiles->each(function ($file) use ($oFPDI, $orientation, $duplexSafe) {
            ...
            if ($file['pages'] == 'all') {
                ...
                for ($i = 1; $i <= $count; $i++) {
                    ...
                    $oFPDI->AddPage($autoOrientation, [$size['width'], $size['height']], $file['rotation']);
